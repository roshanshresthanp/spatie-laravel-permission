    ...
    <p>Yoy are logged from admin guard</p>
                ...
                <form id="demo-form" action="{{route('test.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form">
                            ...
                            <input id="thumbnail" class="form-control" type="text" name="pictures">
                          </div>
                          <img id="holder" style="margin-top:15px;max-height:100px;">
                          
                          <div class="g-recaptcha" data-sitekey="6LcgC08eAAAAAOb64MLmtbGj3Cel8_UAchI5GzWC"></div>
        ...
        <div class="col-md-8">
            <div class="row">
                ...
                <label>{{$loop->iteration}}</label>
                    @foreach(explode(',',$img->pictures) as $test)
                    {{-- {{$img->pictures}}; --}}
                    <div class="col">
                    <label>Image preview</label>
                    <img src="{{$test}}" alt="image" height="80" width="60">
                    @endforeach
                </div>
                @empty
                    <p>No image found</p>
